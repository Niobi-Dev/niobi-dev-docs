...
Once you have integrated with our sandbox and finished testing the API, you can migrate to making live payments by setting up an account with us as discussed above. 
